...
function write(e) {
  var a = "string" == typeof e ? function (e) {
    const n = encodeURIComponent(e)['replace'](/%([0-9A-F]{2})/g, (function (e, r) {
...
export function generate_a_bogus(url_search_params, user_agent) {
   ...
   */
  const random_str = generate_random_str()
  console.log("======== random_str ========: ", random_str);
  const rc4_bb_str = generate_rc4_bb_str(
    url_search_params,
    user_agent,
    "1536|747|1536|834|0|30|0|0|1536|834|1536|864|1525|747|24|24|Win32"
  )
  console.log("======== rc4_bb_str ========: ", rc4_bb_str);
  let result_str = random_str + rc4_bb_str;
